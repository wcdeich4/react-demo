...
describe('Matrix tests', () => {
  ...
  it('Matrix.setLookAtMatrix first octant camera', () => {
    const cameraPosition = new Vector([10, 10, 10]);
    const origin = new Vector([0, 0, 0]);
    const focalPoint = <Vector>origin;
  ...
  it('Matrix.setLookAtMatrix y-axis camera', () => {
    const cameraPosition = new Vector([0, 10, 0]);
    const origin = new Vector([0, 0, 0]);
    const focalPoint = <Vector>origin;
    const upVector = new Vector([0, 0, 1]);
  ...
  it('Matrix.setLookAtMatrix test 2 singularity', () => {
    ...
    const vectorArray = new Array<Vector>();
  ...
  it('GenericMatrix.SetColumn', () => {
    ...
    m2.elements[1][0] = 3;
    m2.elements[1][1] = 4;
    const v = new Vector([9, 8, 7]);
    m2.setColumn(6, v.elements);
  ...
  it('transoform should match multiply on right', () => {
    ...
    const v1MultipliedOnRight = A.multiplyByVectorOnRight(v1);

    A.transformVectorOnRight(v1);

    expect(v1.elements[0]).toEqual(v1MultipliedOnRight.elements[0]);
    expect(v1.elements[1]).toEqual(v1MultipliedOnRight.elements[1]);
    expect(v1.elements[2]).toEqual(v1MultipliedOnRight.elements[2]);
